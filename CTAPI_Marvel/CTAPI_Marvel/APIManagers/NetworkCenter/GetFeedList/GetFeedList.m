...
#import "GetFeedList.h"
#import "CTMarvelService.h"

NSString * const kGetFeedListParamKey<#API param name#> = @"<#API param name#>";

@interface GetFeedList () <CTAPIManagerValidator>
